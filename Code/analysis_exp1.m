...
for isub = 1:numel(files)
    ...
    % data(abs(error)>guessErrorAll(isub),:) = [];
    target = data(:,17);
    error = data(:,20);
    whetherCued = data(:,6);
    condition = data(:,4);
...
saveas(gca,fullfile(mainPath,'results/exp1', 'remember_cue.svg'));
saveas(gca,fullfile(mainPath,'results/exp1', 'remember_cue.png'));
%%
figure(); set(gcf,'color','w', 'Units', 'Normalized', 'OuterPosition', [0 0 0.4 0.5], 'Visible', 'on'); hold on
...
saveas(gca,fullfile(mainPath,'results/exp1', 'forget_cue.svg'));
saveas(gca,fullfile(mainPath,'results/exp1', 'forget_cue.png'));
%%
...
saveas(gca,fullfile(mainPath,'results/exp1', 'remember_item.svg'));
saveas(gca,fullfile(mainPath,'results/exp1', 'remember_item.png'));
...
saveas(gca,fullfile(mainPath,'results/exp1', 'neutral_item.svg'));
saveas(gca,fullfile(mainPath,'results/exp1', 'neutral_item.png'));
%%
